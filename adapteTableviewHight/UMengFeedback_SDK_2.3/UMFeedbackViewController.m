...
//        [self.navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName, [UIFont systemFontOfSize:20], NSFontAttributeName, nil]];
        ...
        titleLabel.text = UM_Local(@"Feedback");
...
//                                                                forIndexPath:indexPath];
    ...
    if ([info[@"type"] isEqualToString:@"user_reply" ]) {
        self.outgoingBubbleImageView.image=[UIImage imageNamed:@"outPut"];
        self.outgoingBubbleImageView.highlightedImage=[UIImage imageNamed:@"outPut"];
        cell.isRightAlign = YES;
        cell.messageBackgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"outgo"]
                                                       highlightedImage:[UIImage imageNamed:@"outgo"]];
    } else {
        self.incomingBubbleImageView.image=[UIImage imageNamed:@"income"];
        self.incomingBubbleImageView.highlightedImage=[UIImage imageNamed:@"income"];
        cell.isRightAlign = NO;
        
        cell.messageBackgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"inCome"]
                                                       highlightedImage:[UIImage imageNamed:@"inCome"]];
    }

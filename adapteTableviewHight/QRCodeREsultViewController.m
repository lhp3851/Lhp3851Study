...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title=@"扫描结果";
    SesameGlobalWebView *globalView = [[SesameGlobalWebView alloc] initWithFrame:CGRectMake(0, 0, screenWidth, screenHight-tablebarHight+24) DataString:self.URLString];

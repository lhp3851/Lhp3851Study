//
//  AVVedioTakePhotoViewController.m
//  AVFoundatonStudy
//
...
#import "AVVedioTakePhotoViewController.h"
#import "LXButton.h"

@interface AVVedioTakePhotoViewController ()<UIGestureRecognizerDelegate>
@property (strong,nonatomic) AVCaptureSession *captureSession;//负责输入和输出设备之间的数据传递
@property (strong,nonatomic) AVCaptureDeviceInput *captureDeviceInput;//负责从AVCaptureDevice获得输入数据
@property (strong,nonatomic) AVCaptureStillImageOutput *captureStillImageOutput;//照片输出流
@property (strong,nonatomic) AVCaptureVideoPreviewLayer *captureVideoPreviewLayer;//相机拍摄预览图层
@property (strong, nonatomic) UIView   *viewContainer;
@property (strong, nonatomic) LXButton *takeButton;//拍照按钮
...
@implementation AVVedioTakePhotoViewController

-(UIView *)viewContainer{
    if (!_viewContainer) {
        _viewContainer=[UIView new];
        _viewContainer.alpha=1.0f;
        _viewContainer.backgroundColor=[UIColor blackColor];
        _viewContainer.frame=self.view.bounds;
    }
...
-(LXButton *)takeButton{
    if (!_takeButton) {
        _takeButton=[LXButton setTitle:@"" normaTitleColor:[UIColor blueColor] heilightTitleColor:[UIColor whiteColor] prohibitTitleColor:[UIColor grayColor] normaBackGroundColor:[UIColor orangeColor] heilightBackGroundColor:[UIColor lightGrayColor] prohibitBackGroundColor:[UIColor grayColor] buttonType:UIButtonTypeCustom];
        [_takeButton setFrame:CGRectMake(kSCREENWIDTH/2-40, kSCREENHEIGHT-95, 80, 80)];
        _takeButton.layer.masksToBounds=YES;
        _takeButton.layer.cornerRadius=_takeButton.frame.size.width/2;
...
-(UIButton *)flashOnButton{
    if (!_flashOnButton) {
        ...
        [_flashOnButton setTitle:@"flashOn" forState:UIControlStateNormal];
        [_flashOnButton setFrame:CGRectMake(15, 75, (kSCREENWIDTH-60)/3, 20)];
        [_flashOnButton setBackgroundColor:[UIColor orangeColor]];
...
-(UIButton *)flashOffButton{
    if (!_flashOffButton) {
        ...
        [_flashOffButton setTitle:@"flashOff" forState:UIControlStateNormal];
        [_flashOffButton setFrame:CGRectMake((kSCREENWIDTH-60)/3+15*2, 75, (kSCREENWIDTH-60)/3, 20)];
        [_flashOffButton setBackgroundColor:[UIColor orangeColor]];
...
-(UIButton *)flashAutoButton{
    if (!_flashAutoButton) {
        ...
        [_flashAutoButton setTitle:@"flashAuto" forState:UIControlStateNormal];
        [_flashAutoButton setFrame:CGRectMake(((kSCREENWIDTH-60)/3+15)*2+15, 75, (kSCREENWIDTH-60)/3, 20)];
        [_flashAutoButton setBackgroundColor:[UIColor orangeColor]];
